...
{{--                     <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <div class="form-row">
                            ...
                            @include('partials.articulos.modificarf.datos_articulo')
                        </div>
                        {{-- LINEA 2 --}}
                        <div class="form-row">
                            <legend class="text-black-50">Codificación</legend>
                            @include('partials.articulos.modificarf.datos_codigos')
                        </div>
                        <div class="form-row">
                            <div class="col-6">
                                <div class="form-check">
                                    <label class="form-check-label m-1">
                                        <input type="checkbox" class="form-check-input" name="artconbar" id="artconbar" value="1" {{($articulo->artcodcont == 1 && !old('artconbar')) ? 'checked' : (old('artconbar') == 1 ? 'checked' : '')}}>
                        ...
                        <div class="form-row">
                            ...
                            @include('partials.articulos.modificarf.datos_clasificacion')
                        </div>
                        {{-- LINEA 4 --}}
                        <div class="form-row">
                            <legend class="text-black-50">Datos comerciales</legend>
                            @include('partials.articulos.modificarf.datos_comerciales')
                        </div>
                        {{-- LINEA 5 --}}
                        <div class="form-row">
                            <legend class="text-black-50">Datos de stock</legend>
                            @include('partials.articulos.modificarf.datos_stock')
                            {{-- fracionamiento --}}
                        </div>
                        <div class="form-row">
                            <div class="col-6">
                                <div class="form-check">
                                    <label class="form-check-label m-1">
                                        <input type="checkbox" class="form-check-input" name="artfrac" id="artfrac" value="1" {{($articulo->artfraccion == 1  && !old('artfrac')) ? 'checked' : (old('artfrac') == 1 ? 'checked' : '')}}>
                        ...
                        <div class="form-row">
                            <div class="col-3">
                                <div class="form-check">
                                    <label class="form-check-label m-1">
                                        <input type="checkbox" class="form-check-input" name="artnegativo" id="artnegativo" value="1" {{($articulo->artneg== 1  && !old('artnegativo')) ? 'checked' : (old('artnegativo') == 1 ? 'checked' : '')}}>
                        ...
                        <div class="form-row">
                            ...
                            @include('partials.articulos.modificarf.datos_varios')
                        </div>
                        <div class="form-row">
                            <div class="col-3">
                                <div class="form-check">
                                    <label class="form-check-label m-1">
                                        <input type="checkbox" class="form-check-input" name="artinactive" id="artinactive" value="1" {{($articulo->artinactive== 1  && !old('artinactive')) == 1 ? 'checked' : (old('artinactive') == 1 ? 'checked' : '')}}>
                                        Desactivar
                                    </label>
                                </div>
                            </div>
