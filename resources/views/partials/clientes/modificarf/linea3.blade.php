                            ...
                            <div class="col-2">
                                <div class="form-group">
                                  ...
                                  <select class="form-control {{$errors->has('suc') ? 'is-invalid' : ''}}" name="suc" id="suc">
                                    ...
                                    <option value="{{$s->sid}}" {{ $cliente->clisuc == $s->sid ? 'selected' : '' }}>{{$s->sdes}}</option>
                                    @endforeach
                                  </select>
                                    @if($errors->has('suc'))
                            ...
                            <div class="col-2">
                                <div class="form-group">
                                  ...
                                  <select class="form-control {{$errors->has('zona') ? 'is-invalid' : ''}}" name="zona" id="zona">
                                    <option value="">Seleccionar</option>
                                    @foreach($zonas as $z)
                                    <option value="{{$z->zid}}" {{ $cliente->clizona == $z->zid ? 'selected' : '' }}>{{$z->zdes}}</option>
                                    @endforeach
                                  </select>
                                  @if($errors->has('zona'))
                            ...
                            <div class="col-2">
                                <div class="form-group">
                                  ...
                                  <select class="form-control {{$errors->has('catcli') ? 'is-invalid' : ''}}" name="catcli" id="catcli">
                                    ...
                                    <option value="{{$tc->tcid}}" {{ $cliente->clicatcli == $tc->tcid ? 'selected' : '' }}>{{$tc->tcdes}}</option>
                                    @endforeach
                                  </select>
                            ...
                            <div class="col-2">
                                <div class="form-group">
                                  ...
                                  <select class="form-control {{$errors->has('responsable') ? 'is-invalid' : ''}}" name="responsable" id="responsable">
                                    <option value="">Seleccionar</option>
                                    @foreach($iva as $res)
                                    <option value="{{$res->crid}}" {{ $cliente->clicatres == $res->crid ? 'selected' : '' }}>{{$res->crdes}}</option>
                                    @endforeach
                                  </select>
                            ...
                            <div class="col-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control {{$errors->has('limcred') ? 'is-invalid' : ''}}" name="limcred" id="limcred" aria-describedby="helpId" placeholder="" value="{{!$errors->has('limcred') ? $cliente->clilimcre : old('limcred')}}">
                            ...
                            <div class="col-2">
                                <div class="form-group">
                                    ...
                                    <select class="form-control {{$errors->has('venta') ? 'is-invalid' : ''}}" name="venta" id="venta">
                                      <option value="">Seleccionar</option>
                                      @foreach($ventas as $v)
                                      <option value="{{$v->cvid}}" {{ $cliente->cliconven == $v->cvid ? 'selected' : '' }}>{{$v->cvdes}}</option>
                                      @endforeach
                                    </select>
                                    @if($errors->has('venta'))
                            ...
                            <div class="col-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="des" id="des" aria-describedby="helpId" placeholder="" value="{{!$errors->has('des') ? $cliente->clidescue : old('des')}}">
                                </div>
                            </div>
