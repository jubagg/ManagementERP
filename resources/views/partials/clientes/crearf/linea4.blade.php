                            ...
                            <div class="col-2">
                                <div class="form-group">
                                  ...
                                  <select class="form-control" name="catiibb" id="catiibb">
                                    ...
                                    @foreach($iibb as $ib)
                                    <option value="{{$ib->ibid}}">{{$ib->ibdes}}</option>
                                    @endforeach
                                  </select>
                                </div>
                            </div>
                            ...
                            <div class="col-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="iibb" id="iibb" aria-describedby="helpId" placeholder="" value="{{old('iibb')}}">
                                </div>
                            </div>
                            {{-- Categoria ganancias --}}
                            <div class="col-2">
                                <div class="form-group">
                                  ...
                                  <select class="form-control" name="catgan" id="catgan">
                                    ...
                                    <option value="{{$cg->cgid}}">{{$cg->cgdes}}</option>
                                    @endforeach
                                  </select>
                                </div>
                            </div>
