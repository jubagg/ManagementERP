                            ...
                            <div class="col-2">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="codigo" id="codigo" value="{{$errors->has('codigo') ? '' : old('codigo')}}" class="form-control {{$errors->has('codigo') ? 'is-invalid' : ''}}" placeholder="" aria-describedby="helpId" required>
                                    </div>
                            ...
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nombre" id="nombre" class="form-control {{$errors->has('nombre') ? 'is-invalid' : ''}}" placeholder="" aria-describedby="helpId" required value="{{$errors->has('nombre') ? '' : old('nombre')}}">
                            ...
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{$errors->has('rsocial') ? '' : old('rsocial')}}" name="rsocial" id="rsocial" class="form-control {{$errors->has('rsocial') ? 'is-invalid' : ''}}" placeholder="" aria-describedby="helpId" required>
                            ...
                            <div class="col-2">
                                ...
                                <option value="{{$d->tdid}}" {{ old('documento') == $d->tdid ? 'selected' : '' }}>{{$d->tddes}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-2">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="numdoc" id="numdoc" value="{{$errors->has('numdoc') ? '' : old('numdoc')}}" class="form-control {{$errors->has('numdoc') ? 'is-invalid' : ''}}" placeholder="" aria-describedby="helpId" required>
                                    </div>
